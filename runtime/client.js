window.__ModuleLoader__.load({
	id: "@deepseek-ai/dsh-client-ui-settings-remote",
	factory: (require) => {
		var module = { exports: {} };
		...
		//#endregion
		//#region \0dsh-css:D:\Work\dsh remote\host-workspace\deepseek-harness\packages\client\ui-settings-remote\src\client\RemoteSettingsSection.module.css.mjs
		...
		const css = ".dRYJKW_page{width:min(100%,860px);color:var(--dsw-alias-label-primary);flex-direction:column;gap:18px;display:flex}.dRYJKW_hero{border:1px solid var(--dsw-alias-border-l2);background:radial-gradient(circle at 90% 10%, color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, transparent), transparent 42%), var(--dsw-alias-bg-layer-3);border-radius:16px;justify-content:space-between;align-items:flex-start;gap:24px;padding:24px;display:flex;position:relative;overflow:hidden}.dRYJKW_hero:after{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent);content:\"\";pointer-events:none;border-radius:50%;width:180px;height:180px;position:absolute;bottom:-72px;right:-36px}.dRYJKW_eyebrow{color:var(--dsw-alias-state-business-primary);letter-spacing:.14em;margin-bottom:8px;font-size:10px;font-weight:700;line-height:16px;display:block}.dRYJKW_hero h2,.dRYJKW_hero p,.dRYJKW_panelHeading h3,.dRYJKW_panelHeading p,.dRYJKW_failure p,.dRYJKW_actionError,.dRYJKW_empty,.dRYJKW_unavailable h3,.dRYJKW_unavailable p{margin:0}.dRYJKW_hero h2{z-index:1;letter-spacing:-.02em;text-wrap:balance;font-size:22px;font-weight:650;line-height:30px;position:relative}.dRYJKW_hero p{z-index:1;max-width:590px;color:var(--dsw-alias-label-secondary);margin-top:8px;font-size:13px;line-height:21px;position:relative}.dRYJKW_localBadge{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 82%, transparent);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;align-items:center;gap:7px;padding:5px 9px;font-size:11px;line-height:16px;display:inline-flex;position:relative}.dRYJKW_localBadge>span{background:var(--dsw-alias-state-success-primary);width:7px;height:7px;box-shadow:0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent);border-radius:50%}.dRYJKW_content{flex-direction:column;gap:14px;display:flex}.dRYJKW_panel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:14px;padding:20px}.dRYJKW_discoveryToggle{cursor:pointer;align-items:flex-start;gap:12px;margin-top:16px;display:flex}.dRYJKW_discoveryToggle input{margin-top:3px}.dRYJKW_discoveryToggle strong,.dRYJKW_discoveryToggle small{display:block}.dRYJKW_discoveryToggle small{color:var(--dsw-alias-label-secondary);margin-top:4px;font-size:12px;line-height:18px}.dRYJKW_discoveryStatus{color:var(--dsw-alias-label-secondary);margin:12px 0 0;font-size:12px;line-height:18px}.dRYJKW_discoveryStatus[data-published=true]{color:var(--dsw-alias-label-primary)}.dRYJKW_panelHeading{min-width:0}.dRYJKW_panelTitle{align-items:center;gap:8px;display:flex}.dRYJKW_panelTitle h3,.dRYJKW_unavailable h3{text-wrap:balance;font-size:14px;font-weight:650;line-height:21px}.dRYJKW_panelTitle>span{background:var(--dsw-alias-bg-layer-1);min-width:20px;color:var(--dsw-alias-label-tertiary);text-align:center;font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 6px;font-size:11px;line-height:18px}.dRYJKW_panelHeading p,.dRYJKW_unavailable p{max-width:690px;color:var(--dsw-alias-label-tertiary);margin-top:4px;font-size:12px;line-height:19px}.dRYJKW_headingWithAction{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.dRYJKW_pageStatus,.dRYJKW_empty{color:var(--dsw-alias-label-tertiary);padding:18px 2px;font-size:13px;line-height:20px}.dRYJKW_failure,.dRYJKW_actionError{border:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 28%, transparent);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 7%, transparent);color:var(--dsw-alias-state-error-primary);border-radius:10px;justify-content:space-between;align-items:center;gap:12px;padding:11px 13px;font-size:12px;line-height:19px;display:flex}.dRYJKW_unavailable{border:1px dashed var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);border-radius:14px;align-items:flex-start;gap:13px;padding:20px;display:flex}.dRYJKW_unavailableIcon{background:var(--dsw-alias-bg-layer-1);width:34px;height:34px;color:var(--dsw-alias-label-secondary);border-radius:10px;flex:none;place-items:center;display:grid}.dRYJKW_invitationHint{color:var(--dsw-alias-label-secondary);margin:14px 0 0;font-size:12px;line-height:19px}.dRYJKW_invitationEmpty{background:var(--dsw-alias-bg-module-platform);border-radius:12px;justify-content:space-between;align-items:center;gap:20px;margin-top:18px;padding:18px;display:flex}.dRYJKW_profilePicker{border:0;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:18px 0 0;padding:0;display:grid}.dRYJKW_profilePicker>legend{color:var(--dsw-alias-label-secondary);margin-bottom:8px;font-size:12px;font-weight:600;line-height:18px}.dRYJKW_profileOption{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);cursor:pointer;border-radius:11px;align-items:flex-start;gap:10px;min-width:0;padding:12px;display:flex}.dRYJKW_profileOption[data-selected=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 52%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module-platform))}.dRYJKW_profileOption>input{width:16px;height:16px;accent-color:var(--dsw-alias-state-business-primary);flex:none;margin:2px 0 0}.dRYJKW_profileOption>span{flex-direction:column;gap:3px;min-width:0;display:flex}.dRYJKW_profileOption strong{font-size:12px;font-weight:650;line-height:18px}.dRYJKW_profileOption small{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.dRYJKW_phoneGlyph{border:2px solid var(--dsw-alias-border-l1);border-radius:10px;width:38px;height:54px;position:relative}.dRYJKW_phoneGlyph>span{background:var(--dsw-alias-label-tertiary);border-radius:2px;width:10px;height:2px;position:absolute;top:6px;left:50%;transform:translate(-50%)}.dRYJKW_phoneGlyph>i{background:var(--dsw-alias-state-business-primary);border-radius:50%;width:4px;height:4px;position:absolute;bottom:5px;left:50%;transform:translate(-50%)}.dRYJKW_invitationGrid{background:var(--dsw-alias-bg-module-platform);border-radius:12px;grid-template-columns:184px minmax(0,1fr);gap:20px;margin-top:18px;padding:16px;display:grid}.dRYJKW_invitationGrid[data-expired=true] .dRYJKW_qrFrame{opacity:.36;filter:grayscale()}.dRYJKW_qrFrame{aspect-ratio:1;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-tertiary);border-radius:10px;place-items:center;font-size:11px;line-height:17px;display:grid;overflow:hidden}.dRYJKW_qrFrame img{width:100%;height:100%;display:block}.dRYJKW_invitationDetails{flex-direction:column;justify-content:center;gap:14px;min-width:0;display:flex}.dRYJKW_invitationStatus,.dRYJKW_expired{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary);border-radius:999px;align-self:flex-start;padding:3px 8px;font-size:11px;line-height:17px}.dRYJKW_expired{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 9%, transparent);color:var(--dsw-alias-state-error-primary)}.dRYJKW_detail{flex-direction:column;gap:4px;min-width:0;display:flex}.dRYJKW_detail>span{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.dRYJKW_detail code,.dRYJKW_deviceMain code{overflow-wrap:anywhere;color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code);font-size:11px;line-height:18px}.dRYJKW_invitationActions,.dRYJKW_pendingActions{flex-wrap:wrap;gap:8px;display:flex}.dRYJKW_pendingList,.dRYJKW_deviceList{flex-direction:column;gap:10px;margin:16px 0 0;padding:0;list-style:none;display:flex}.dRYJKW_pendingCard{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 24%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 4%, var(--dsw-alias-bg-module-platform));border-radius:12px;grid-template-columns:minmax(150px,1fr) minmax(128px,.7fr);gap:14px 20px;padding:16px;display:grid}.dRYJKW_pendingIdentity{align-items:center;gap:11px;min-width:0;display:flex}.dRYJKW_pendingIdentity>div{flex-direction:column;gap:2px;min-width:0;display:flex}.dRYJKW_pendingIdentity strong,.dRYJKW_deviceTitle strong{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:19px;overflow:hidden}.dRYJKW_pendingIdentity small{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.dRYJKW_deviceAvatar{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, var(--dsw-alias-bg-layer-1));width:34px;height:34px;color:var(--dsw-alias-state-business-primary);border-radius:10px;flex:none;place-items:center;font-size:13px;font-weight:650;display:grid}.dRYJKW_verification{flex-direction:column;justify-content:center;align-items:flex-end;gap:2px;display:flex}.dRYJKW_verification span{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.dRYJKW_verification strong{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);letter-spacing:.12em;font-variant-numeric:tabular-nums;font-size:24px;font-weight:650;line-height:30px}.dRYJKW_pendingActions{justify-content:flex-end;align-items:flex-end}.dRYJKW_deviceRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:11px;align-items:center;gap:12px;padding:13px 14px;display:flex}.dRYJKW_deviceRow[data-revoked=true]{opacity:.68}.dRYJKW_deviceMain{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.dRYJKW_deviceTitle{align-items:center;gap:8px;min-width:0;display:flex}.dRYJKW_deviceTitle>span{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary);border-radius:999px;flex:none;padding:1px 7px;font-size:10px;line-height:16px}.dRYJKW_deviceTitle>span[data-state=revoked]{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-tertiary)}.dRYJKW_deviceMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:4px 12px;font-size:10px;line-height:16px;display:flex}@media (width<=720px){.dRYJKW_hero{flex-direction:column}.dRYJKW_invitationGrid{grid-template-columns:minmax(0,1fr)}.dRYJKW_qrFrame{width:min(100%,240px)}.dRYJKW_pendingCard,.dRYJKW_profilePicker{grid-template-columns:minmax(0,1fr)}.dRYJKW_verification{align-items:flex-start}.dRYJKW_pendingActions{justify-content:flex-start}.dRYJKW_deviceRow{flex-wrap:wrap;align-items:flex-start}}@media (width<=480px){.dRYJKW_hero,.dRYJKW_panel{padding:16px}.dRYJKW_invitationEmpty{flex-direction:column;align-items:flex-start}}";
		const tagId = "@deepseek-ai/dsh-client-ui-settings-remote/RemoteSettingsSection.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-settings-remote";
		...
		var RemoteSettingsSection_module_css_default = {
			"empty": "dRYJKW_empty",
			"deviceMain": "dRYJKW_deviceMain",
			"unavailableIcon": "dRYJKW_unavailableIcon",
			"pendingCard": "dRYJKW_pendingCard",
			"expired": "dRYJKW_expired",
			"pendingIdentity": "dRYJKW_pendingIdentity",
			"verification": "dRYJKW_verification",
			"pendingActions": "dRYJKW_pendingActions",
			"profileOption": "dRYJKW_profileOption",
			"phoneGlyph": "dRYJKW_phoneGlyph",
			"deviceList": "dRYJKW_deviceList",
			"panelTitle": "dRYJKW_panelTitle",
			"deviceRow": "dRYJKW_deviceRow",
			"localBadge": "dRYJKW_localBadge",
			"page": "dRYJKW_page",
			"invitationEmpty": "dRYJKW_invitationEmpty",
			"invitationDetails": "dRYJKW_invitationDetails",
			"deviceAvatar": "dRYJKW_deviceAvatar",
			"detail": "dRYJKW_detail",
			"pageStatus": "dRYJKW_pageStatus",
			"invitationHint": "dRYJKW_invitationHint",
			"invitationActions": "dRYJKW_invitationActions",
			"actionError": "dRYJKW_actionError",
			"unavailable": "dRYJKW_unavailable",
			"deviceMeta": "dRYJKW_deviceMeta",
			"hero": "dRYJKW_hero",
			"pendingList": "dRYJKW_pendingList",
			"failure": "dRYJKW_failure",
			"panel": "dRYJKW_panel",
			"profilePicker": "dRYJKW_profilePicker",
			"invitationGrid": "dRYJKW_invitationGrid",
			"eyebrow": "dRYJKW_eyebrow",
			"headingWithAction": "dRYJKW_headingWithAction",
			"invitationStatus": "dRYJKW_invitationStatus",
			"deviceTitle": "dRYJKW_deviceTitle",
			"panelHeading": "dRYJKW_panelHeading",
			"qrFrame": "dRYJKW_qrFrame",
			"content": "dRYJKW_content",
			"discoveryStatus": "dRYJKW_discoveryStatus",
			"discoveryToggle": "dRYJKW_discoveryToggle"
		};
		//#endregion
		...
		function InvitationPanel({ invitation, profile, phoneReachable, busy, onProfileChange, onCreate, t }) {
			...
			(0, react.useEffect)(() => {
				...
				setQr(void 0);
				setQrFailed(false);
				if (invitation !== void 0) import_browser.toDataURL(invitation.invitationUri, {
		...
		//#endregion
		//#region src/client/remote-api.ts
		/**
